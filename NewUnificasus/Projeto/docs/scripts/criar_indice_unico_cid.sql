-- Criar índice único para prevenir duplicatas em RL_PROCEDIMENTO_CID
-- Este índice garante que não haverá duplicatas de CO_PROCEDIMENTO + CO_CID + DT_COMPETENCIA
...
WHERE TRIM(R.RDB$RELATION_NAME) = 'RL_PROCEDIMENTO_CID'
  AND TRIM(I.RDB$INDEX_NAME) = 'IDX_RL_PCID_UNIQUE'
...
-- Limpe as duplicatas primeiro usando limpar_duplicatas_cid.sql
