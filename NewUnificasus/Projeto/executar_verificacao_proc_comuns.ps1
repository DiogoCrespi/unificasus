# Script PowerShell para executar verificação de tabelas de procedimentos comuns no Firebird
...
$ScriptPath = ".\verificar_tabelas_proc_comuns.sql"
...
Write-Host "Executando verificação de tabelas de procedimentos comuns..." -ForegroundColor Green
...
try {
    ...
    $outputFile = "resultado_verificacao_proc_comuns.txt"
